# Vendored from https://github.com/shiyu-coder/Kronos (MIT, see LICENSE here),
# commit 67b630e67f6a18c9e9be918d9b4337c960db1e9a, file model/kronos.py.
# Kronos is not packaged (the PyPI "kronos" is an unrelated Django app).
# Local change: the package import below (was sys.path.append + "from model.module import *"). Nothing else is edited.
